...
var IForbitSwapV2Pair = _interopDefault(require('@forbitswap/v2-core/build/IForbitswapPair.json'));
...
var FACTORY_ADDRESS = '0x44b7256d25613855Fdaaf4C788CF8CB02B7A3717';
var INIT_CODE_HASH = '0xd8ee896fc63070b0e43b4f7646fa27e8336829eaf3e40c8f5aab132bd5af0d96';
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'UNI-V2', 'ForbitSwap V2');
...
var ZERO_HEX = '0x0';
/**
 * Represents the ForbitSwap V2 Router, and has static methods for helping execute trades.
 */
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IForbitSwapV2Pair.abi, provider).getReserves()).then(function (_ref) {
